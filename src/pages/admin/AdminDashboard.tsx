    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4">
        ...
        <div className="flex gap-3">
          ...
          <Link
            to="/admin/settings"
            className="px-4 py-2 bg-slate-700 dark:bg-slate-600 text-white rounded-xl text-xs font-semibold flex items-center gap-1.5 hover:scale-[1.02] transition-transform"
          >
